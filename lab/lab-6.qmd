...
b.  Create an appropriate data visualization to compare the distribution of weights of male and female coquerel's sifaka lemurs. Provide a brief interpretation of this visualization.
...
a.  Fit the appropriate model to predict whether a baby was classified as low birthweight (Low) from length of pregnancy in weeks (`weeks`), and display a tidy summary of the model output. **Make sure you use only the training data**.
...
d.  Now, fit the appropriate model to predict a baby was classified as low birthweight (Low) from length of pregnancy in weeks (`weeks`), mother's smoking status (`habit`), and mother's maturity (`mature`), and display a tidy summary of the model output. **Make sure you use only the training data**.
