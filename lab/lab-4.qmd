...
b.  Then, visualize the relationship between `divergence_time` and `transformed_parsim`, making sure to place the outcome (y) and predictor (x) variables on the appropriate axes. Add a regression line to your visualization.
...
-   In the WSJ this very week: "[The 30-Year Debate Over the Minimum Wage Is Still Not Settled](https://www.wsj.com/economy/jobs/minimum-wage-jobs-cost-debate-card-krueger-63b21af2?st=kFawiR&reflink=desktopwebshare_permalink);"
