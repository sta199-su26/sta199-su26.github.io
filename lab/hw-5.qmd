...
description: "Due: Wed, Mar 25, 11:59 pm"
categories: HW
filters:
  - ../remove-fmt-skip.lua
draft: false
...
- **Part 1 -- 🤖 Feedback from AI:** Not graded, for practice, you get immediate feedback with AI, based on rubrics designed by the course instructor. Complete in `hw-5-part-1.qmd`, no submission required.

- **Part 2 -- 🧑🏽‍🏫 Feedback from Humans:** Graded, you get feedback from the course instructional team in about a week. Complete in `hw-5-part-2.qmd`, submit on Gradescope.
...
Your answers to the questions in this part should go in the file `hw-5-part-1.qmd`.

## Instructions

Write your answer to each question in the appropriate section of the `hw-5-part-1.qmd` file.
...
Your answers to the questions in this part should go in the file `hw-5-part-2.qmd`.
