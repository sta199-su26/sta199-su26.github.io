...
-   Go to the course organization at [github.com/sta199-su26](https://github.com/sta199-su26) organization on GitHub.
    Click on the repo with the prefix **ae**.
    This is your application exercise (AE) repo.
    It contains the starter documents you need to complete your AE for today's lecture (and will contain the starter files for future AEs).
