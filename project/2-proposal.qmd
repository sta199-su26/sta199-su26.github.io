...
::: callout-note
You will start working on this milestone in lab, but you will likely need to finish it outside of lab.
...
You shouldn't feel constrained to datasets that are already in a tidy format, you can start with data that needs cleaning and tidying.
