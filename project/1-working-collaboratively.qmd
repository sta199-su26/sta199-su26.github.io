...
This activity is about resolving *merge conflicts*, which can arise when multiple people are using Git and GitHub to collaborate on the same repository. The TA will demonstrate before you begin the activity, but you can also read more [here](1-working-collaboratively-preread.qmd).
