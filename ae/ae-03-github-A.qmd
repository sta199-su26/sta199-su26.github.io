...
-   **Your turn:** Describe what the code is doing in words.
    ...
    This code is filtering for flights that landed at either RDU (Raleigh) or GSO (Greensboro) **AND** either took off early **OR** landed early.
...
-   **Your turn:** What is the median departure delay for each airports around NYC (`origin`)?
