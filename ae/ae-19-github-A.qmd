...
If the null were true, the probability of observing a sample statistic ($b_1$) as or more extreme than the one we observe (-0.012) is 0.068.
Since 0.068 \> 0.05, we fail to reject the null hypothesis.
We do not have sufficient evidence for a nonzero correlation between state and employment difference.
