...
format: 
  revealjs: 
    output-file: 19-logistic-regression-1-slides.html
...
## Reminder: project peer eval

- Please submit it on time!
- Dig the emails out of your spam/junk folder;
- "Teamwork" is 10% of your project score;
- These later peer evals bear the most weight in assessing that;
- Please be thorough and honest.
...
![](images/19/spam.png){fig-align="center" width="70%"}
...
![](images/19/fico.jpg){fig-align="center" width="60%"}
...
![](images/19/tswift.png){fig-align="center" width="40%"}
