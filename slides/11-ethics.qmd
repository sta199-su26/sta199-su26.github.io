...
format: 
  revealjs: 
    output-file: 14-ethics-slides.html
...
No technique, and no AE. Just sit back and ponder:
...
![](images/14/ga-dph-declining-bars.jpg){width="750"}
...
![](images/14/ga-dph-corrected-bars.png){width="900"}
...
::: {.column width="30%"}
![](images/14/machine-bias.png){fig-align="center" width="800"}
:::
:::
...
::: {.column width="30%"}
![](images/14/machine-bias-petty-theft-1.png){fig-align="center" width="300" height="250"} ![](images/14/machine-bias-petty-theft-2.png){fig-align="center" width="300" height="180"}
:::

::: {.column width="30%"}
![](images/14/machine-bias-drug-posession-1.png){fig-align="center" width="300" height="250"} ![](images/14/machine-bias-drug-posession-2.png){fig-align="center" width="300" height="180"}
:::
:::
...
::: {.column width="60%"}
![](images/14/machine-bias-risk-scores.png){fig-align="center" width="480"}
:::
:::
...
![](images/14/lending.png) Armies of stats PhDs go to work on these models. They have no training in the ethics of what they're doing.
...
![](images/14/flo.png){width="24%"} ![](images/14/clue.png){width="24%"} ![](images/14/per_calendar.png){width="24%"} ![](images/14/stardust.png){width="24%"}
...
## This would be...very bad for JZ

![](images/14/nyt_data_privacy.png)
...
![](images/14/nih-woops.png){width="60%"}
...
![](images/14/aol-data-leak.png){width="800"}
...
::: columns
::: column
![](images/14/propublica-machine-bias.png){width="400"}
:::
