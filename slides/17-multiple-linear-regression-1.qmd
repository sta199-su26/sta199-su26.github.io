...
format: 
  revealjs: 
    output-file: 17-multiple-linear-regression-1-slides.html
...
## Do you know what Duke invests in? Neither does Nathan! {.small}

![](images/17/nathan.png){fig-align="center"}
...
:::::: columns
:::: {.column width="50%"}
{{< qrcode https://forms.gle/euNGfxbmZzBJGK1j7 width=300 height=300 >}}
::::
...
## Bookbagging this Thursday! {.scrollable}
