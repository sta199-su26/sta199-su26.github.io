...
format: 
  revealjs: 
    ...
    footer: "[🔗 sta199-su26.github.io](https://sta199-su26.github.io/)"
    theme: slides.scss
    transition: fade
    slide-number: true
...
-   Today:
    ...
    -   We will finish yesterday's AE, and get an introduction to Git, GitHub, and Quarto;
...
![](img/02/tour-quarto.png){fig-alt="RStudio IDE with a Quarto document, source code on the left and output on the right. Annotated to show the YAML, a link, a header, and a code cell." fig-align="center"}
...
![](img/02/un-data-viz.png)

## Data science lessons {.scrollable}
...
## Data science lessons (continued) {.scrollable}

::: question
This class is about technique bolstered by *good taste* and *aesthetics*.
:::

-   The plot is fairly technically sophisticated (lots of moving parts), and it looks rather attractive;
-   We certainly want you to learn how to create something *aesthetic* like that;
-   But after you're done admiring it, your *good taste* should kick in;
-   Is this picture *actually* communicating what I want it to effectively?
...
## Take a peek at the data {.scrollable .smaller}
```{r}
#| label: glimpse-data
glimpse(un_votes)
...
## The bottom line, at the top {.smaller}
...
![](img/02/aesthetic-mapping.gif){fig-align="center"}
...
::: callout-note
Functionally, the `geom` layer(s) tell R what type of plot you want to create. In particular, `geom_point()` corresponds to a *scatterplot*. 
:::
...
## Data viz with ggplot is like building a cake {.scrollable}
...
::: {.column width="50%"}
![](img/02/cake.jpg){width="65%"}
:::
:::::

. . .

The commands are the layers of sponge, and the plus signs are the icing.
